...
dev_build(){
  ...
  export MAVEN_OPTS="-Djavax.net.debug=all -Djavax.net.ssl.trustStore=/usr/lib/jvm/jdk8/jre/lib/security/cacerts -Djavax.net.ssl.trustStorePassword=changeit -Djavax.net.ssl.trustStoreType=JKS"
